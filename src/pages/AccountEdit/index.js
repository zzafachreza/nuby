    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{
                ...
                <MyGap jarak={5} />
                <MyInput label="Asal Sekolah" placeholder="masukan asal sekolah" multiline iconname="home-outline" value={kirim.asal_sekolah} onChangeText={x => setKirim({ ...kirim, asal_sekolah: x })} />
                ...
                {!loading && <MyButton warna={colors.secondary} colorText={colors.black} iconColor={colors.black} onPress={sendServer} title="Simpan Perubahan" Icons="download-outline" />}
                <MyGap jarak={20} />
            </ScrollView>
        </SafeAreaView >
    )
