      ...
      {!loading &&
        <View style={{
          ...
          <View style={{
            ...
            }} placeholder='Pencarian . . .' placeholderTextColor={colors.white} style={{
              height: 45,
              borderWidth: 1,
          ...
          <FlatList data={data} showsVerticalScrollIndicator={false} numColumns={2} renderItem={__renderItem} />
